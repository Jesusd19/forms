...
export class DataComponent{
  ...
  constructor() { 
    ...
    this.forma.controls['username'].valueChanges.subscribe( res => {
      console.log(res);
      
    })
    this.forma.controls['username'].statusChanges.subscribe( res => {
      console.log(res);
  ...
  guardarCambios(){
    ...
    // this.forma.setValue( this.usuario ); no resetea las clases 
